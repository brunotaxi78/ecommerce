								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
											<label class="" for="billing_address_1">Código Postal <abbr title="required" class="required">*</abbr>
											</label>
											<?php if( isset($address["deszipcode"]) ){ ?>

                                            <input type="text" value="<?php echo htmlspecialchars( $address["deszipcode"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="0000-000" id="billing_address_1" name="zipcode" class="input-text ">
                                            <input type="submit" value="Atualizar Cód.Postal" id="place_order" class="button alt" formaction="/checkout" formmethod="get">
											<?php }else{ ?>

											<input type="text" value="" placeholder="0000-000" id="billing_address_1" name="zipcode" class="input-text ">
                                            <input type="submit" value="Atualizar Cód.Postal" id="place_order" class="button alt" formaction="/checkout" formmethod="get">
											<?php } ?>
										...
										<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
											...
											<input type="text" value="" placeholder="Morada" id="billing_address_1" name="desaddress" class="input-text ">
											<?php } ?>

										</p>
										<p id="billing_address_2_field" class="form-row form-row-wide address-field">
											<input type="text" value="" placeholder="NºPorta / Andar" id="billing_address_2" name="descomplement" class="input-text ">
                                        </p>
										...
										<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											<label class="" for="billing_state">Concelho</label>
											<?php if( isset($address["deszipcode"]) ){ ?>
										...
										<p id="billing_district_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
											<label class="" for="billing_district">Distrito <abbr title="required" class="required">*</abbr>
											</label>
											<?php if( isset($address["deszipcode"]) ){ ?>
